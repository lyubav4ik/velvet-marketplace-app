...
Зарегистрировано: `vl-maison-header` (id=2, тег v0.6) — шапка MAISON v7: одна строка [меню в 2 строки слева | лого | иконки], критичная раскладка инлайнами, поиск ведёт в корень каталога.
